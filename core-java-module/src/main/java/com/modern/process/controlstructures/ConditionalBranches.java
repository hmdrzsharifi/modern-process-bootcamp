...
public class ConditionalBranches {
    ...
    public static void ifElseStatementsExamples() {
        ...
        // Basic syntax. More then one statement can be included. Braces are used (recommended syntax).
        if (count > 1) {
            System.out.println("Count is higher than 1");
        ...
        if (count > 2) {
            ...
            System.out.println("Count is less or equal then zero");
        } else {
    ...
    /**
     * Switch structure example. Shows how to replace multiple if/else statement with one structure
     */
